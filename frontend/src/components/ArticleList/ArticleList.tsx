  ...
  return (
    <ListGroup as="ul" className="article-list-container">
      ...
      {news.map((article, id) => {
        return (
          <div key={id}>
            <ListGroup.Item action as="li" className="article-item" onClick={() => handleArticleClick(article)}>
      ...
      >
        ...
        <Modal.Body>
          {selectedArticle && (
            <>
              <p>{selectedArticle.content ? selectedArticle.content : `${t('No_content_to_display.1')}`}</p>
              <p>
